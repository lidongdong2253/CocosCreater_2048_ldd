(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.b7646.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.27cac.js');
            require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.6733f.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.6733f.js';
